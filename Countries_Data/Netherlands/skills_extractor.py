...
# --- ΡΥΘΜΙΣΕΙΣ ---
INPUT_PATH  = r"C:/Users/Desktop PC/Desktop/ΔΙΠΛΩΜΑΤΙΚΗ/linkedin/Netherlands/UPDATED/Netherlands_merged_deduped_translated.csv"
OUTPUT_PATH = r"C:/Users/Desktop PC/Desktop/ΔΙΠΛΩΜΑΤΙΚΗ/linkedin/Netherlands/UPDATED/Netherlands_with_skills.csv"
TEXT_COL    = "descriptionText"   # άλλαξέ το σε "description" αν χρειάζεται
BATCH       = 50                  # progress ανά 50 γραμμές
# -------------------
...
# 3) Αρχικοποίηση extractor (1η φορά μπορεί να αργήσει για κατέβασμα μοντέλων)
...
with tqdm(total=N, desc="Extracting skills", unit="rows", dynamic_ncols=True) as pbar:
    for start in range(0, N, BATCH):
        ...
        pbar.update(len(chunk))  # ενημέρωση με ΠΡΑΓΜΑΤΙΚΕΣ γραμμές
